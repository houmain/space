...
import { GameEventNotifier } from '../../logic/event/eventInterfaces';
...
export class InitGameScene extends GuiScene {
	...
	private startGame() {
		this.scene.start(Scenes.GAME, {
			...
			galaxyDataHandler: this._gameState.galaxyDataHandler,
			clientMessageSender: this._gameState.clientMessageSender,
			gameEventObserver: this._gameState.gameEventObserver,
			serverMessageQueue: this._gameState.serverMessageQueue,
			timeController: this._gameState.timeController*/
		});
...
/*
export class InitGameScene2 extends GuiScene {
